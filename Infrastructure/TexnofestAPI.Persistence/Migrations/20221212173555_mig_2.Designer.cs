...
namespace TexnofestAPI.Persistence.Migrations
{
    ...
    [Migration("20221212173555_mig_2")]
    partial class mig2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TexnofestAPI.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("TexnofestAPI.Domain.Entities.Identity.AspNetUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AppUserProduct", b =>
                {
                    b.HasOne("TexnofestAPI.Domain.Entities.Identity.AspNetUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TexnofestAPI.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
